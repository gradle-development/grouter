...
const has9RouterConfig = (globalState) => {
  ...
  return isOpenAi && (baseUrl.includes("localhost") || baseUrl.includes("127.0.0.1") || baseUrl.includes("grouter"));
};
...
export async function DELETE() {
  try {
    ...
    return NextResponse.json({ success: true, message: "Grouter settings removed from Cline" });
  } catch (error) {
